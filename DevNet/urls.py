...
from network.controller import iot_device, user, monitor, network_device, profile, deploy_config, config, router_config, switch_config
...
urlpatterns = [
    ...
    path('deploy/', monitor.dashboard_deploy, name='dashboard-deploy'),
    # register
    path('register/', user.register, name='register'),
    path('register/add/', user.adduser, name='adduser'),
    # Begin Iot Device
    path('iot_device/', iot_device.iot_list, name='iot-list'),
    path('iot_device/iot_add/', iot_device.iot_add, name='iot_add'),
    path('iot_device/new', iot_device.iot_new, name='iot_new'),
    ...
    path('config/<int:id>,<int:profile_id>,<int:network_type_id>,<int:network_id>',
         iot_device.config, name="config"),
    path('deploy_config/<int:id>',
         deploy_config.deploy_config, name="deploy-all"),
    path('deploy_vlan/<int:id>',
         deploy_config.deploy_vlan, name="deploy-vlan"),
    path('deploy_hostname/<int:id>',
         deploy_config.deploy_hostname, name="hostname-domain"),
    path('deploy_interface/<int:id>',
         deploy_config.deploy_interface, name="interface-deploy"),
    path('deploy_interface_all/<int:id>',
         deploy_config.deploy_interface_all, name="interface-all-deploy"),
    ...
    path('router/eigrp/name',
         router_config.eigrp_create_name, name="eigrp-create-name"),
    # Trunk Route
    path('switch/switchport', switch_config.switchport_list, name="switchport-list"),
    path('switch/switchport/add',
         switch_config.switchport_create, name="switchport-create"),
    path('switch/switchport/edit/<int:id>',
         switch_config.switchport_edit, name="switchport-edit"),
    path('switch/switchport/delete/<int:id>',
         switch_config.switchport_delete, name="switchport-delete"),
    # Etherchannel Route
    path('switch/etherchannel', switch_config.etherchannel_list,
         name="etherchannel-list"),
    path('switch/etherchannel/add',
         switch_config.etherchannel_create, name="etherchannel-create"),
    path('switch/etherchannel/edit/<int:id>',
         switch_config.etherchannel_edit, name="etherchannel-edit"),
    path('switch/etherchannel/delete/<int:id>',
         switch_config.etherchannel_delete, name="etherchannel-delete"),
]
